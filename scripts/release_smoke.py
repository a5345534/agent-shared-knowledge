#!/usr/bin/env python3
"""Release gate for a clean, tested, packable v0.1.0 checkout."""
...
def main() -> int:
    ...
    if package.get("version") != "0.1.0":
        print("release version must be 0.1.0", file=sys.stderr); return 1
    ...
    print("release smoke passed for v0.1.0")
    return 0
